...
-- Phase 64 Plan 03: Extend get_screen_diagnostics to include device_metrics
-- Adds device_metrics and metrics_updated_at to the screen object in the RPC response
...
BEGIN
  ...
  -- Get screen info (includes device_metrics and metrics_updated_at from migration 149)
  SELECT
    d.id,
    d.device_name,
    d.owner_id,
  ...
  -- Build result (extended with device_metrics and metrics_updated_at)
...
'Returns diagnostics for a screen including device_metrics telemetry data.
Extended in migration 151 to include device_metrics and metrics_updated_at.';
