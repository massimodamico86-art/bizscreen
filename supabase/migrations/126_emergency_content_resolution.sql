-- =====================================================
-- BIZSCREEN: EMERGENCY CONTENT RESOLUTION
-- =====================================================
-- Modifies get_resolved_player_content to check emergency state first.
-- Emergency content has highest priority (999), overrides all schedules
-- and campaigns.
--
-- Resolution order:
-- 1. Emergency content (if active and not expired)
-- 2. Active schedule entries (highest priority first)
-- 3. Assigned layout
-- 4. Assigned playlist
-- =====================================================
...
-- Update comment
COMMENT ON FUNCTION public.get_resolved_player_content(UUID) IS 'Resolves and returns player content based on emergency state, schedule, layout, or playlist assignments. Emergency content has priority 999 and overrides all other sources.';

-- =====================================================
-- END OF EMERGENCY CONTENT RESOLUTION
-- =====================================================
