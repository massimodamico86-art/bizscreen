...
(function (global, factory) {
    ...
    ***************************************************************************** */
	...
	var ScopeSet = /** @class */ (function () {
		...
		ScopeSet.prototype.containsScopeSet = function (scopeSet) {
			...
			return (
				...
				scopeSet.asArray().every(function (scope) {
	...
	var AccountEntity = /** @class */ (function () {
		...
		AccountEntity.createAccount = function (clientInfo, homeAccountId, idToken, authority, cloudGraphHostName, msGraphHost, environment, nativeAccountId) {
			...
			if (idToken) {
				...
				account.localAccountId =
					((_b = idToken === null || idToken === void 0 ? void 0 : idToken.claims) === null || _b === void 0 ? void 0 : _b.oid) ||
					((_c = idToken === null || idToken === void 0 ? void 0 : idToken.claims) === null || _c === void 0 ? void 0 : _c.sub) ||
		...
		AccountEntity.createGenericAccount = function (homeAccountId, idToken, authority, cloudGraphHostName, msGraphHost, environment) {
			...
			if (idToken) {
				// How do you account for MSA CID here?
				account.localAccountId =
					((_a = idToken === null || idToken === void 0 ? void 0 : idToken.claims) === null || _a === void 0 ? void 0 : _a.oid) ||
					((_b = idToken === null || idToken === void 0 ? void 0 : idToken.claims) === null || _b === void 0 ? void 0 : _b.sub) ||
					Constants.EMPTY_STRING;
		...
		AccountEntity.isAccountEntity = function (entity) {
			...
			return (
				entity.hasOwnProperty('homeAccountId') && entity.hasOwnProperty('environment') && entity.hasOwnProperty('realm') && entity.hasOwnProperty('localAccountId') && entity.hasOwnProperty('username') && entity.hasOwnProperty('authorityType')
			);
		};
		/**
	...
	var AccessTokenEntity = /** @class */ (function (_super) {
		 ...
		 * @param extExpiresOn
		 */
		AccessTokenEntity.createAccessTokenEntity = function (
			homeAccountId,
			environment,
			accessToken,
			clientId,
	...
	var InteractionRequiredAuthError = /** @class */ (function (_super) {
		...
		InteractionRequiredAuthError.isInteractionRequiredError = function (errorCode, errorString, subError) {
			...
			var isInteractionRequiredErrorDesc =
				!!errorString &&
				InteractionRequiredServerErrorMessage.some(function (irErrorCode) {
							...
							return [
								...
								responseHandler
									...
									.then(function (result) {
										var _a;
										atsMeasurement === null || atsMeasurement === void 0
											? void 0
						...
						case 1:
							...
							return [
								...
								this.executePostToTokenEndpoint(endpoint, requestBody, headers, thumbprint)
									.then(function (result) {
										acquireTokenMeasurement === null || acquireTokenMeasurement === void 0
											? void 0
	...
	var Authority = /** @class */ (function () {
		...
		Object.defineProperty(Authority.prototype, 'defaultOpenIdConfigurationEndpoint', {
			 ...
			 */
			get: function () {
				if (this.authorityType === AuthorityType.Adfs || this.authorityType === AuthorityType.Dsts || this.protocolMode === exports.ProtocolMode.OIDC) {
				...
				return __generator(this, function (_f) {
					switch (_f.label) {
						...
						case 1:
							...
							azureRegion =
								((_b = this.authorityOptions.azureRegionConfiguration) === null || _b === void 0 ? void 0 : _b.azureRegion) === Constants.AZURE_REGION_AUTO_DISCOVER_FLAG
									? autodetectedRegionName
									: (_c = this.authorityOptions.azureRegionConfiguration) === null || _c === void 0
									? void 0
									: _c.azureRegion;
							if (((_d = this.authorityOptions.azureRegionConfiguration) === null || _d === void 0 ? void 0 : _d.azureRegion) === Constants.AZURE_REGION_AUTO_DISCOVER_FLAG) {
								...
								if (autodetectedRegionName) {
									this.regionDiscoveryMetadata.region_outcome =
										((_e = this.authorityOptions.azureRegionConfiguration) === null || _e === void 0 ? void 0 : _e.azureRegion) === autodetectedRegionName
		...
		Authority.buildRegionalAuthorityString = function (host, region, queryString) {
			...
			var url = UrlString.constructAuthorityUriFromObject(
				__assign(__assign({}, authorityUrlInstance.getUrlComponents()), {
	...
	var StandardInteractionClient = /** @class */ (function (_super) {
		...
		StandardInteractionClient.prototype.initializeLogoutRequest = function (logoutRequest) {
			...
			var validLogoutRequest = __assign$1(
				{
			...
			return __awaiter$1(this, void 0, void 0, function () {
				...
				return __generator$1(this, function (_b) {
					switch (_b.label) {
						...
						case 1:
							validatedRequest = __assign$1.apply(void 0, [
								__assign$1.apply(void 0, _a.concat([_b.sent()])),
								{
				...
				return __generator$1(this, function (_a) {
					switch (_a.label) {
						...
						case 6:
							...
							return [
								2 /*return*/,
								this.handleNativeResponse(validatedResponse, nativeRequest, reqTimestamp)
									.then(function (result) {
										nativeATMeasurement.endMeasurement({
											success: true,
											isNativeBroker: true,
				...
				return __generator$1(this, function (_b) {
					switch (_b.label) {
						...
						case 5:
							...
							expiresIn = responseTokenType === exports.AuthenticationScheme.POP ? Constants.SHR_NONCE_VALIDITY : (typeof response.expires_in === 'string' ? parseInt(response.expires_in, 10) : response.expires_in) || 0;
					...
					switch (_a.label) {
						case 0:
							...
							validatedRequest = __assign$1(__assign$1({}, remainingProperties), {
								...
								extraParameters: __assign$1(__assign$1(__assign$1({}, request.extraQueryParameters), request.tokenQueryParameters), {
				...
				return __generator$1(this, function (_a) {
					switch (_a.label) {
						...
						case 4:
							...
							return [
								4 /*yield*/,
								authClient.getAuthCodeUrl(
									__assign$1(__assign$1({}, validRequest), {
						...
						case 0:
							...
							if (serverParams.accountId) {
								...
								nativeInteractionClient = new NativeInteractionClient(
									...
									exports.ApiId.acquireTokenPopup,
								...
								return [
									...
									nativeInteractionClient
										.acquireToken(
											__assign$1(__assign$1({}, cachedRequest), {
					...
					switch (_a.label) {
						...
						case 5:
							...
							this.eventHandler.emitEvent(
								exports.EventType.POPUP_OPENED,
				...
				return __generator$1(this, function (_a) {
					switch (_a.label) {
						case 0:
							...
							return [
								4 /*yield*/,
								this.initializeAuthorizationRequest(
									__assign$1(__assign$1({}, request), {
					...
					switch (_a.label) {
						...
						case 1:
							...
							return [
								4 /*yield*/,
								authClient.getAuthCodeUrl(
									__assign$1(__assign$1({}, silentRequest), {
				...
				return __generator$1(this, function (_b) {
					switch (_b.label) {
						...
						case 2:
							...
							encodedKeyIdThumbprint = this.b64Encode.urlEncode(
								JSON.stringify({
									kid: kid,
								})
							);
			...
			return __awaiter$1(this, void 0, void 0, function () {
				...
				return __generator$1(this, function (_a) {
					switch (_a.label) {
						...
						case 2:
							_a.trys.push([2, 4, , 5]);
							authCodeRequest = __assign$1(__assign$1({}, silentRequest), {
								code: request.code,
							});
	...
	var ClientApplication = /** @class */ (function () {
					...
					if (this.isBrowserEnvironment) {
						...
						if (typeof response === 'undefined') {
							...
							if (request && NativeMessageHandler.isNativeAvailable(this.config, this.logger, this.nativeExtensionProvider) && this.nativeExtensionProvider && !hash) {
								...
								nativeClient = new NativeInteractionClient(
									this.config,
									this.browserStorage,
									this.browserCrypto,
									this.logger,
									this.eventHandler,
									this.navigationClient,
									exports.ApiId.handleRedirectPromise,
									this.performanceClient,
				...
				return __generator$1(this, function (_a) {
					...
					if (this.nativeExtensionProvider && this.canUseNative(request)) {
						nativeClient = new NativeInteractionClient(
							...
							this.eventHandler,
							this.navigationClient,
							exports.ApiId.acquireTokenRedirect,
							this.performanceClient,
							this.nativeExtensionProvider,
					...
					try {
						if (request.code) {
							...
							if (this.canUseNative(request, request.nativeAccountId)) {
								return [
									2 /*return*/,
									this.acquireTokenNative(request, exports.ApiId.acquireTokenByCode, request.nativeAccountId).catch(function (e) {
										// If native token acquisition fails for availability reasons fallback to standard flow
										if (e instanceof NativeAuthError && e.isFatal()) {
											_this.nativeExtensionProvider = undefined; // If extension gets uninstalled during session prevent future requests from continuing to attempt
										}
		...
		ClientApplication.prototype.createSilentAuthCodeClient = function (correlationId) {
			return new SilentAuthCodeClient(
				...
				this.eventHandler,
				this.navigationClient,
				exports.ApiId.acquireTokenByCode,
				this.performanceClient,
				this.nativeExtensionProvider,
				correlationId
			);
			...
			return __awaiter$1(this, void 0, void 0, function () {
				...
				return __generator$1(this, function (_a) {
					...
					if (typeof cachedResponse === 'undefined') {
						...
						response = this.acquireTokenSilentAsync(
							__assign$1(__assign$1({}, request), {
								correlationId: correlationId,
							}),
							account
				...
				return __generator$1(this, function (_a) {
					switch (_a.label) {
						case 0:
							...
							silentRequest = __assign$1(__assign$1({}, request), {
								account: account,
							});
