...
- [x] **FEAT-01**: User can generate a complete layout from a text prompt via AI Designer
...
- [x] **FEAT-07**: User can edit app configuration from apps page
