...
must_haves:
  ...
  artifacts:
    ...
    - path: "api/translations/suggest.js"
  ...
  key_links:
    ...
    - from: "src/components/translations/AiSuggestionPanel.jsx"
      to: "api/translations/suggest.js"
      via: "fetch POST"
...
<task type="auto">
  ...
  <files>src/components/translations/AiSuggestionPanel.jsx, api/translations/suggest.js, src/services/translationService.js</files>
  <action>
1. Create api/translations/suggest.js (Next.js/Vercel API route pattern):
```javascript
...
Use framer-motion AnimatePresence for slide animation (following TemplatePreviewPanel pattern).
  ...
  <verify>test -f api/translations/suggest.js && test -f src/components/translations/AiSuggestionPanel.jsx && grep -q "getAiTranslationSuggestion" src/services/translationService.js</verify>
...
2. API route exists: `ls api/translations/suggest.js`
