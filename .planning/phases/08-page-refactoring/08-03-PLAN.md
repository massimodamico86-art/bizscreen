...
4. Verify drag-drop reordering works (manual check):
   - Confirm handleDragStart, handleDragOver, handleDrop, handleDragEnd are exported from hook
   - Verify drag handlers are wired to PlaylistStripItem in the page
   - Confirm reordering state (dragIndex, dropIndex) is accessible from hook
...
Fix any issues before completing.
  ...
  <verify>
    ...
    - Drag handlers exported from hook and wired in page
  </verify>
  <done>
    - All linting passes
