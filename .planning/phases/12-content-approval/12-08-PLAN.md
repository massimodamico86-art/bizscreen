...
**Navigation pattern verification:** Check how onNavigate is called in the component. Based on DashboardPage, the pattern is `setCurrentPage(pageName)` where pageName is like 'screens', 'playlists', 'scene-editor'. Follow this exact pattern for scene navigation.
  </action>
