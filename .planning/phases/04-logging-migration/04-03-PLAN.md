...
<task type="auto">
  <name>Task 1: Migrate auth and security services</name>
  <files>
    src/services/authService.js
    src/services/mfaService.js
    src/services/sessionService.js
...
<task type="auto">
  <name>Task 2: Migrate player and telemetry services</name>
  <files>
    src/services/playerService.js
    src/services/playerAnalyticsService.js
    src/services/playbackTrackingService.js
...
2. Apply same transformation rules as Task 1.
...
<task type="auto">
  <name>Task 3: Migrate billing, GDPR, and tenant services</name>
  <files>
    src/services/billingService.js
    src/services/gdprService.js
    src/services/tenantService.js
