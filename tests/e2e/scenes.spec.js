...
// SKIP REASON: Scenes feature not accessible via sidebar navigation -- page exists at /app/scenes but
// no nav button is wired up. Re-enable when Scenes is added to the sidebar.
test.describe.skip('Scenes', () => {
