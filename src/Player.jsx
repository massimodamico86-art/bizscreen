...
// sceneDesignService imports moved to SceneRenderer.jsx
// mediaPreloader imports moved to SceneRenderer.jsx
import {
  subscribeToSceneUpdates,
  checkDeviceRefreshStatus,
  clearDeviceRefreshFlag,
} from './services/deviceSyncService';
// weatherService, WeatherWall, QRCodeSVG imports moved to AppRenderer.jsx
import {
  pollForCommand,
  reportCommandResult,
  updateDeviceStatus,
...
// dataBindingResolver, dataSourceService imports moved to SceneRenderer.jsx
import {
  initTracking,
  stopTracking,
  trackSceneStart,
...
// adaptivePreload, detectBandwidth moved to SceneRenderer.jsx
...
import { AppRenderer } from './player/components/AppRenderer';
...
// ============================================================================
// COMPONENTS EXTRACTED TO player/components/
// - SceneRenderer.jsx: Scene/slide rendering with transitions and data binding
// - LayoutRenderer.jsx: Multi-zone layout rendering
// - ZonePlayer.jsx: Single zone playback
// - AppRenderer.jsx: App type routing (clock, weather, web page, etc.)
// - PairPage.jsx: OTP pairing page
// ============================================================================
