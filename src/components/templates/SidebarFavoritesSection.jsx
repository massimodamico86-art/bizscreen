 ...
 *
 * Compact collapsible section showing favorited templates in the sidebar.
 * Displays up to maxItems templates with thumbnail and name.
 * Hidden when no favorites exist.
 *
 * @module components/templates/SidebarFavoritesSection
 */
 ...
 *
 * @param {Object} props
 * @param {Array} props.templates - Array of favorited template objects
