...
export default function TemplatePickerModal({ onClose, onSelectTemplate }) {
  ...
  const loadTemplates = useCallback(async () => {
    ...
    try {
      ...
      logger.error('Failed to load templates', { error: err, categoryId: selectedCategory, searchQuery });
  ...
  const handleSelectTemplate = async (template) => {
    ...
    try {
      ...
      logger.error('Failed to install template', { error: err, templateId: template.id, templateName: template.name });
